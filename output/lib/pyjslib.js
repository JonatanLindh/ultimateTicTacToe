...
;
	throw ($p['TypeError'](('unsupported operand type(s) for &: ')+(', '['join'](function(){
...
;
	...
	$m['___import___'] = function(path, context, module_name, get_base) {
		...
		var $bool18,$bool19,$and13,$bool17,$and8,$and9,$and6,$and7,pyjslib,path_parts,inContextImportName,$bool47,$attr8,module,contextTopName,$bool25,$bool24,$bool27,$bool26,$bool21,$bool20,$bool23,$bool22,$bool29,$bool28,$attr9,$bool46,$bool45,$bool44,$bool43,$bool42,$bool41,$bool40,$attr5,$attr7,$attr6,$bool49,$bool48,$and12,topName,inContextTopName,$bool32,$bool33,$bool30,$bool31,$bool36,$bool37,$bool34,$bool35,$and16,$bool38,$bool39,$and17,$bool54,$bool55,$bool56,$bool57,$bool50,$bool51,$bool52,$bool53,$bool58,$bool59,$eq10,objName,$bool61,$bool60,$bool63,$bool62,$attr27,$bool64,$bool66,$9,$14,$15,$16,$17,$10,$11,$12,$13,$18,$19,save_track_module,parentName,$attr20,$attr21,$attr22,$attr23,$attr24,$attr25,$attr26,is_module_object,$attr28,$bool65,in_context,$20,$eq8,$eq9,$eq2,$eq3,$eq1,$eq6,$eq7,$eq4,$eq5,sys,importName,$and10,$and11,$attr19,$attr18,$and14,$and15,$attr15,$attr14,$attr17,$attr16,$attr11,$attr10,$attr13,$attr12,$cmp4,$cmp1,$cmp3,$cmp2,depth,inContextParentName;
...
$pyjs['track']['module'] = save_track_module;
	...
	$m['__dynamic_load__'] = function(importName) {
		var $or1,$or3,$bool67,$or2,$bool69,$bool68,$bool72,module,$bool71,$pyjs_try_err,$bool70;
		;
		...
		if ((($bool70=typeof module== 'undefined') === null || $bool70 === false || $bool70 === 0 || $bool70 === '' ?
				...
				(typeof $bool70=='object'?
					(typeof $bool70['__nonzero__']=='function'?
					 ...
					 true ) )) {
			try {
				$m['dynamic']['ajax_import']((((('lib/')+(importName))+('.__'))+($m['platform']))+('__.js'));
				module = $pyjs['loaded_modules'][importName];
			} catch($pyjs_try_err) {
		...
		if ((($bool71=typeof module== 'undefined') === null || $bool71 === false || $bool71 === 0 || $bool71 === '' ?
				...
				(typeof $bool71=='object'?
					(typeof $bool71['__nonzero__']=='function'?
					 ...
					 true ) )) {
			try {
				$m['dynamic']['ajax_import']((('lib/')+(importName))+('.js'));
				module = $pyjs['loaded_modules'][importName];
			} catch($pyjs_try_err) {
				var $pyjs_try_err_name = (typeof $pyjs_try_err['__name__'] == 'undefined' ? $pyjs_try_err['name'] : $pyjs_try_err['__name__'] );
				$pyjs['__last_exception__'] = {'error': $pyjs_try_err, 'module': $m};
...
namespace[name] = module[name];
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('__repr__', function() {
			...
			var $bool78,$attr44,$attr42,$attr43,$attr40,$attr41,$attr39;
			...
			return (self['__name__'])+($p['repr'](self['args']));
		}
	, 1, [null,null,['self']]);
		$cls_definition['__repr__'] = $method;
		var $bases = new Array(pyjslib['object']);
...
(function(){
	...
	, 1, [null,null,['self'],['y']]);
		...
		$method = $pyjs__bind_method2('__mul__', function(n) {
			...
			var a,$bool87,$bool86,$bool88,$attr61,$attr62;
...
self['__array'][self['__array']['length']] = item;
	...
	, 1, [null,null,['self'],['y']]);
		...
		$method = $pyjs__bind_method2('__mul__', function(n) {
			...
			var a,$attr69,$bool99,$bool101,$bool100,$attr70;
...
$m['list']['toString'] = $m['list']['__str__'];
	...
	, 1, ['args',null,['self'],['a1']]);
		...
		$method = $pyjs__bind_method2('__cmp__', function(x) {
			...
			var $attr82,$attr80,$attr81,$attr79,$attr78,$attr77,$attr76,$attr74,$attr73,$attr72,$attr71,$bool105,$bool104,r,$eq11,$eq12,$eq13,$eq14,$attr75;
	...
	, 1, [null,null,['self'],['x']]);
		...
		$method = $pyjs__bind_method2('indices', function(length) {
			...
			var $or5,$cmp21,$cmp26,defstart,$and22,$cmp27,$bool124,$bool112,$bool113,$bool110,$bool111,$bool116,$bool117,$bool114,$bool115,$cmp17,$cmp29,$bool118,$bool119,$eq15,$eq16,$attr83,$cmp22,$and20,$attr86,$attr87,$attr84,$attr85,$cmp19,$attr88,$attr89,$cmp18,start,$cmp31,$bool122,$cmp30,$bool125,$cmp23,$or4,$cmp28,$cmp38,stop,defstop,$and21,$cmp15,$cmp14,$bool107,$bool106,$cmp11,$cmp10,$cmp13,$cmp12,step,$cmp36,$cmp35,$cmp34,$bool109,$bool108,$bool121,$bool120,$cmp33,$attr94,$cmp7,$attr91,$attr90,$attr93,$attr92,$cmp37,slicelength,$and23,$cmp9,$cmp8,$cmp16,$bool123,$cmp24,$cmp20,$cmp32,$cmp25;
			step = 0;
			start = 0;
			stop = 0;
...
$m['slice']['toString'] = $m['slice']['__str__'];
	...
	, 1, ['args',['kwargs'],['self']]);
		...
		$method = $pyjs__bind_method2('pop', function(k) {
			...
			var $34,$36,res,$35,$33,$bool134,$pyjs_try_err,$cmp42,$bool135,$cmp41,$len8,$len9;
					...
					(typeof $bool134=='object'?
						(typeof $bool134['__nonzero__']=='function'?
							...
							(typeof $bool134['__len__']=='function'?
								...
								true ) ) :
						 true ) )) {
				throw ($m['TypeError']($p['sprintf']('pop expected at most 2 arguments, got %s', (1)+((($len9=d) === null?0:
...
$m['frozenset']['toString'] = $m['frozenset']['__repr__'];
	...
	$m['range'] = function(start, stop, step) {
		if (typeof stop == 'undefined') stop=arguments['callee']['__args__'][3][1];
		if (typeof step == 'undefined') step=arguments['callee']['__args__'][4][1];
		var $bool200,$cmp43,$bool201,$cmp44,$bool198,$bool199,$bool193,$bool196,$bool197,$bool194,$bool195,$attr121,$attr122,$attr123,$attr124,$attr125,$attr126,ilow,$eq23,$eq24,items,n,r;
		...
		if ((($bool201=((($cmp43=step)===($cmp44=0)?0:
			...
			n = $m['get_len_of_range'](stop, ilow, -(step));
		}
		r = null;
		items = new Array();
...
throw $m['TypeError']("ord() expected string of length 1");
	...
	$m['zip'] = function() {
		...
		var $38,$bool220,$bool221,$bool222,$pyjs_try_err,n,i,lst,$37,$eq25,t,$eq26,$cmp46,$cmp45;
		n = $m['len'](iterables);
	...
	$m['_reversed'] = function(iterable) {
		var $bool228,i,$bool227,$cmp48,$cmp49,$cmp50,$43,$42,$41,$cmp47,$44;
var $generator_state = [0], $generator_exc = [null], $yield_value = null, $exc = null, $is_executing=false;
	...
	$m['_enumerate'] = function(sequence) {
		var $iter23_type,$iter22_array,$iter23_iter,$iter23_idx,$iter22_nextval,$iter22_idx,item,$iter23_nextval,nextIndex,$iter22_type,$iter23_array,$iter22_iter;
var $generator_state = [0], $generator_exc = [null], $yield_value = null, $exc = null, $is_executing=false;
		var $generator = function () {};
		$generator['next'] = function (noStop) {
	...
	$m['_iter_getitem'] = function(object) {
		var $48,i,$bool234,$bool233,$pyjs_try_err,$47,$46,$45;
var $generator_state = [0], $generator_exc = [null], $yield_value = null, $exc = null, $is_executing=false;
		var $generator = function () {};
		$generator['next'] = function (noStop) {
...
var $generator_state = [0], $generator_exc = [null], $yield_value = null, $exc = null, $is_executing=false;
	...
	$m['min'] = function() {
		...
		var $bool239,$bool241,item,$iter24_idx,minValue,$eq33,$49,$iter24_array,$eq36,$eq34,$eq35,$50,$bool240,$iter24_type,$iter24_iter,$iter24_nextval;
		...
		while (typeof ($iter24_nextval=($iter24_type?($iter24_type > 0?$iter24_iter.next(true,false):$p['wrapped_next']($iter24_iter)):$iter24_array[$iter24_idx++])) != 'undefined') {
			...
			else if ((($bool241=(($eq35=$m['cmp'](item, minValue))===($eq36=-(1))&&$eq35===null?true:
	...
	$m['max'] = function() {
		...
		var $eq40,$iter25_array,$iter25_nextval,maxValue,$iter25_iter,item,$eq37,$iter25_idx,$bool243,$bool242,$51,$eq38,$eq39,$iter25_type,$52,$bool244;
	...
	$m['sum'] = function(iterable, start) {
		...
		var i,$iter26_type,$iter26_nextval,$iter26_idx,$iter26_array,$iter26_iter,$bool245;
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('__add__', function(b) {
			...
			var $attr142,$attr143,$attr140,$attr146,$attr144,$attr145,$bool248,$attr141,$attr137,$attr136,$attr135,$attr139,$attr138,$bool247;
					...
					(typeof $bool247=='object'?
						(typeof $bool247['__nonzero__']=='function'?
							...
							(typeof $bool247['__len__']=='function'?
								...
								true ) ) :
						 true ) )) {
				return $m['complex']((self['real'])+(b['real']), (self['imag'])+(b['imag']));
			}
					...
					(typeof $bool248=='object'?
						(typeof $bool248['__nonzero__']=='function'?
							...
							(typeof $bool248['__len__']=='function'?
								...
								true ) ) :
						 true ) )) {
				return $m['complex']((self['real'])+(b), self['imag']);
			}
			else {
...
p = Math['pow'](x, y);
		...
		return $m['float']((($mod1=p)!=null && ($mod2=z)!=null && typeof $mod1=='string'?
			$m['sprintf']($mod1,$mod2):
...
r = Math['round'](n*x)/n;
	...
	$m['_parse_int'] = function(s, start, end) {
		var result,$bool265,$bool266,$bool267,$bool268,$pyjs_try_err,msg,$cmp58,$cmp51,$cmp53,$cmp52,$cmp55,$cmp54,$cmp57,$cmp56,c,i,$eq42,$eq41,$53,$54;
		result = 0;
		i = start;
	...
	, 1, [null,null,['self'],['args'],['kw']]);
		...
		$method = $pyjs__bind_method2('_build_string', function(start, end, level) {
			...
			var $attr155,$attr156,$bool270,$bool269,s,out;
			out = $m['StringBuilder']();
	...
	, 1, [null,null,['self'],['start'],['end'],['level']]);
		...
		$method = $pyjs__bind_method2('_do_build_string', function(start, end, level, out, s) {
			...
			var field_start,rendered,$cmp60,$bool280,$cmp62,$bool281,nested,$eq54,$eq55,$eq56,$eq57,$eq50,$eq51,$eq52,$eq53,$bool287,at_end,$eq58,$bool283,$bool279,$59,last_literal,$eq59,$eq60,$bool284,$61,$bool275,$62,$eq49,$bool278,$bool276,$or9,$or8,$cmp61,$cmp59,$60,$bool274,recursive,$bool277,markup_follows,c,$eq48,$bool273,$bool272,$bool271,i,$eq47,$eq46,$eq45,$eq44,$58,$eq43,$bool285,$or11,$or10,$assign2,$bool282,$bool286,$55,$56,$57;
			$assign2 = start;
	...
	, 1, [null,null,['self'],['start'],['end'],['level'],['out'],['s']]);
		...
		$method = $pyjs__bind_method2('_parse_field', function(start, end) {
			...
			var $cmp64,$cmp65,$cmp66,$cmp63,$bool288,$bool289,conversion,$eq70,$68,end_name,$65,$64,$67,$66,$63,$bool291,$bool290,$bool293,$bool292,w_msg,c,$bool294,$attr157,$eq69,$eq68,i,$eq64,$eq67,$eq66,$eq61,$attr158,$eq63,$eq62,$eq65,s,$or13,$or12;
			s = self['template'];
			i = start;
	...
	, 1, [null,null,['self'],['start'],['end']]);
		...
		$method = $pyjs__bind_method2('_get_argument', function(name) {
			...
			var $eq78,$cmp67,$attr160,$attr164,$cmp68,kwarg,$attr161,$73,$and29,$and28,$bool309,arg_key,$attr163,$bool307,index,$bool305,$bool304,end,$bool302,$bool301,$bool300,$eq76,$eq77,$eq75,$eq72,$eq73,$attr162,$eq71,$74,$pyjs_try_err,$69,$eq83,use_numeric,msg,$bool311,$attr167,empty,$bool299,$bool298,w_msg,$attr166,$attr174,stop,$bool295,c,$bool297,$bool296,$attr168,$eq82,$bool306,$71,$bool303,$attr169,$72,$attr173,$70,$eq84,$bool310,$eq81,$eq80,i,$attr176,$attr175,$eq79,$attr159,$attr172,$attr171,$attr170,$or15,$or14,$or17,$or16,$attr165,$bool308,$eq74,w_arg;
			i = 0;
			end = $m['len'](name);
					...
					(typeof $bool301['__nonzero__']=='function'?
						...
						(typeof $bool301['__len__']=='function'?
							($bool301['__len__']()>0 ?
								...
								false) :
							true ) ) :
					 true ) )?$or16:!(($eq77=index)===($eq78=-(1))&&$eq77===null?true:
			...
			if ((($bool311=(($eq83=index)===($eq84=-(1))&&$eq83===null?true:
	...
	, 1, [null,null,['self'],['name']]);
		...
		$method = $pyjs__bind_method2('_resolve_lookups', function(w_obj, name, start, end) {
			...
			var $79,$bool316,$cmp72,$83,$cmp69,reached,$bool324,$bool325,got_bracket,$bool327,$eq101,$bool321,$bool320,$bool323,$bool322,$eq90,$eq91,$eq92,$eq93,$eq95,$eq96,$eq97,$eq98,index,$cmp74,w_attr,msg,$eq100,$82,$cmp73,$eq87,$cmp71,$cmp70,$bool326,$bool315,w_msg,$84,$eq85,$81,$80,$eq102,$attr180,w_item,$eq94,$and30,$and31,$77,$bool314,$eq86,c,$bool317,$76,$bool312,$75,i,$78,$bool313,$bool318,$bool319,$eq89,$eq88,$attr177,$eq99,$attr179,$or19,$or18,$attr178;
			i = start;
			while ((($bool312=((($cmp69=i)===($cmp70=end)?0:
				...
				if ((($bool313=(($eq85=c)===($eq86='.')&&$eq85===null?true:
					...
					if ((($bool326=((($bool325=$and30=!(($eq99=index)===($eq100=-(1))&&$eq99===null?true:
	...
	, 1, [null,null,['self'],['w_obj'],['name'],['start'],['end']]);
		...
		$method = $pyjs__bind_method2('formatter_field_name_split', function() {
			...
			var stop,$bool329,$bool328,$bool333,index,$eq103,end,$eq104,$eq107,$eq106,$eq109,$eq108,$or20,$or21,w_first,$cmp77,$cmp76,$cmp75,$86,$85,$cmp78,$attr182,$eq110,$attr181,$attr184,$bool332,$eq105,$bool330,$bool331,c,name,i,$attr183;
			name = self['template'];
			i = 0;
			end = $m['len'](name);
	...
	, 1, [null,null,['self'],['w_obj'],['conversion']]);
		...
		$method = $pyjs__bind_method2('_render_field', function(start, end, recursive, level) {
			...
			var $attr191,$attr190,$attr193,$attr192,$attr195,$attr194,$attr196,$cmp80,conversion,spec,w_rendered,$attr188,$attr189,$attr186,$attr187,$cmp79,$attr185,w_obj,$bool338,$bool339,w_entry,$bool336,$bool337,startm1,$eq116,name,$eq115,spec_start;
	...
	, 1, [null,null,['self'],['start'],['end'],['recursive'],['level']]);
		...
		$method = $pyjs__bind_method2('formatter_parser', function() {
			...
			var $attr197,$attr199,$attr198,$cmp82,$cmp81,$bool340,$attr202,$attr209,w_lastentry,$attr205,$attr204,$attr207,$attr206,$attr201,$attr200,$attr203,$attr208,$attr212,$attr213,$attr210,$attr211,$attr214;
			self['parser_list_w'] = $p['list']([]);
			self['last_end'] = 0;
	...
	, 1, [null,null,['self'],['c']]);
		...
		$method = $pyjs__bind_method2('_parse_spec', function(default_type, default_align) {
			...
			var $eq166,$eq165,$eq164,$eq163,$eq162,$eq161,$eq160,tp,$or29,spec,$and38,$and39,$and34,$and35,$and36,$and37,$and32,$and33,$attr218,$attr219,$attr216,$attr217,$attr215,$attr224,$attr223,$attr222,presentation_type,$eq153,$attr220,$cmp94,$89,$eq159,$and41,$bool358,$bool359,$eq138,$eq139,$eq134,$bool351,$eq136,$eq137,$bool354,$bool355,$bool356,$bool357,length,$and40,$and46,$98,$99,$94,$95,$96,$97,$90,$91,$92,$93,$attr221,$115,$bool349,$bool348,$110,$and45,$and44,$111,$bool347,$bool346,$and43,$and42,the_type,start_i,$bool376,$bool377,$bool374,$bool375,$bool372,$bool373,$bool370,$bool371,$bool350,$eq158,$eq135,$eq156,$eq157,$eq154,$eq155,$eq152,$bool352,$eq150,$eq151,$116,$114,$bool353,$112,$113,$cmp88,$cmp89,$cmp86,$cmp87,$cmp84,$cmp85,$cmp83,$eq131,$eq132,$eq133,$bool361,$bool360,$bool363,$bool362,$bool365,$bool364,$bool367,$bool366,$bool369,$bool368,got_align,$eq149,$eq148,$eq145,$eq144,$eq147,$eq146,$eq141,$eq140,$eq143,$eq142,$101,$100,$103,$102,$105,$104,$107,$106,$109,$108,$cmp91,$cmp90,$cmp93,$cmp92,i,$or33,$or32,$or31,$or30,$or37,$or36,$or35,$or34;
			...
			i = 0;
			got_align = true;
			if ((($bool349=((($bool348=$and32=((((($cmp83=(length)-(i))===($cmp84=2)?0:
				...
				((typeof $91['__array'][$92=(i)+(1)]) != 'undefined'?$91['__array'][$92]:
					$91['__getitem__']($92)):
					$91['__getitem__']((i)+(1)))):$and32)) === null || $bool349 === false || $bool349 === 0 || $bool349 === '' ?
					false :
				...
				self['_align'] = (typeof ($93=spec)['__array'] != 'undefined'?
					((typeof $93['__array'][$94=(i)+(1)]) != 'undefined'?$93['__array'][$94]:
						$93['__getitem__']($94)):
						$93['__getitem__']((i)+(1)));
			...
			else if ((($bool351=((($bool350=$and34=((((($cmp85=(length)-(i))===($cmp86=1)?0:
			...
			if ((($bool353=((($bool352=$and36=((((($cmp87=(length)-(i))===($cmp88=1)?0:
			...
			if ((($bool355=((($bool354=$and38=((((($cmp89=(length)-(i))===($cmp90=1)?0:
					...
					(typeof $bool356['__nonzero__']=='function'?
						...
						(typeof $bool356['__len__']=='function'?
							($bool356['__len__']()>0 ?
								...
								false) :
							true ) ) :
					 true ) )?((($bool357=$and41=((((($cmp91=(length)-(i))===($cmp92=1)?0:
			...
			if ((($bool364=((($bool363=$and45=!(($eq141=length)===($eq142=i)&&$eq141===null?true:
				...
				i = $tupleassign11[1];
				if ((($bool365=(($eq145=self['_precision'])===($eq146=-(1))&&$eq145===null?true:
			...
			if ((($bool366=((($cmp93=(length)-(i))===($cmp94=1)?0:
			...
			if ((($bool367=(($eq147=(length)-(i))===($eq148=1)&&$eq147===null?true:
	...
	, 1, [null,null,['self'],['default_type'],['default_align']]);
		...
		$method = $pyjs__bind_method2('_calc_padding', function(string, length) {
			...
			var right,$attr230,$attr231,$attr232,$bool383,$bool382,$bool381,$bool380,total,$eq167,$and48,$eq169,$eq168,$attr227,$attr226,$attr225,$cmp95,$cmp96,$attr229,$attr228,$or39,$or38,$bool378,$bool379,align,$eq175,$eq170,$eq171,$eq172,$eq173,$eq174,$and47,$eq176,left;
			if ((($bool379=((($bool378=$and47=!(($eq167=self['_width'])===($eq168=-(1))&&$eq167===null?true:
	...
	, 1, [null,null,['self'],['s']]);
		...
		$method = $pyjs__bind_method2('_pad', function(string) {
			...
			var $attr234,$attr235,$attr236,$attr237,$attr233,builder,$attr238,$attr239,$attr240;
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('_unknown_presentation', function(tp) {
			...
			var $attr241,$attr242,w_msg,$mod4,$mod3,msg;
			msg = "unknown presentation for %s: '%s'";
			w_msg = (($mod3=msg)!=null && ($mod4=$p['tuple']([tp, self['_type']]))!=null && typeof $mod3=='string'?
				$m['sprintf']($mod3,$mod4):
	...
	, 1, [null,null,['self'],['tp']]);
		...
		$method = $pyjs__bind_method2('format_string', function(string) {
			...
			var $117,$bool389,$bool388,$bool387,$bool386,$bool385,$bool384,$attr252,$attr253,$attr250,$attr251,$cmp99,$cmp98,$attr244,$and49,$eq185,$attr249,$attr248,msg,$cmp97,$attr243,$attr245,$attr247,$attr246,$eq181,$eq180,$eq183,$eq182,$bool390,precision,$eq184,$cmp100,$eq186,$118,$attr254,$and50,$eq178,$eq179,length,$bool391,$eq177;
			...
			if ((($bool390=((($bool389=$and49=!(($eq183=precision)===($eq184=-(1))&&$eq183===null?true:
	...
	, 1, [null,null,['self'],['string']]);
		...
		$method = $pyjs__bind_method2('_get_locale', function(tp) {
			...
			var $eq188,$attr255,$attr256,$bool392,$bool393,$eq187,dec,thousands,grouping;
	...
	, 1, [null,null,['self'],['tp']]);
		...
		$method = $pyjs__bind_method2('_calc_num_width', function(n_prefix, sign_char, to_number, n_number, n_remainder, has_dec, digits) {
			...
			var $eq198,$eq199,$eq192,$eq193,$eq190,$eq191,$eq196,$eq197,$eq194,extra_length,$eq210,spec,$eq189,$cmp102,$eq195,$attr292,$attr293,$attr290,$attr291,$attr296,$attr297,$attr294,$attr295,$attr298,$bool400,$bool401,$bool402,$bool403,$bool404,$bool405,$bool406,$attr278,$attr279,$attr270,$attr271,$attr272,$attr273,$attr274,$attr275,$attr276,sign,$attr285,$attr284,$attr287,$attr281,$attr280,$attr283,$attr282,$attr289,$attr288,$bool394,$eq203,$eq200,$attr269,$attr268,$attr263,$attr262,$attr261,$attr260,$attr267,$attr266,$attr265,$attr264,$and52,$and51,n_grouped_digits,$attr258,$attr259,$attr257,n_padding,$attr277,$eq201,$cmp101,align,$eq208,$eq209,$bool398,$bool399,$eq202,$bool395,$bool396,$bool397,$eq206,$eq207,$eq204,$eq205,$attr286;
			spec = $m['NumberSpec']();
			...
			extra_length = (((spec['n_sign'])+(spec['n_prefix']))+(spec['n_decimal']))+(spec['n_remainder']);
						...
						(typeof $bool405=='object'?
							(typeof $bool405['__nonzero__']=='function'?
								...
								(typeof $bool405['__len__']=='function'?
									...
									true ) ) :
							 true ) )) {
					spec['n_lpadding'] = Math['floor'](n_padding/2);
			...
			spec['n_total'] = (((((((spec['n_lpadding'])+(spec['n_sign']))+(spec['n_prefix']))+(spec['n_spadding']))+(n_grouped_digits))+(spec['n_decimal']))+(spec['n_remainder']))+(spec['n_rpadding']);
			return spec;
		}
	, 1, [null,null,['self'],['n_prefix'],['sign_char'],['to_number'],['n_number'],['n_remainder'],['has_dec'],['digits']]);
		...
		$method = $pyjs__bind_method2('_fill_digits', function(buf, digits, d_state, n_chars, n_zeros, thousands_sep) {
			...
			var $iter32_idx,$iter32_nextval,$iter31_nextval,$119,$iter32_iter,$iter30_array,$bool407,$iter30_nextval,$iter31_idx,$iter32_type,$iter32_array,$iter30_type,$iter31_array,$iter30_idx,$120,c,$iter30_iter,i,$iter31_iter,$iter31_type;
			...
			$iter31_iter = $m['range']((d_state)-(1), ((d_state)-(n_chars))-(1), -(1));
	...
	, 1, [null,null,['self'],['buf'],['digits'],['d_state'],['n_chars'],['n_zeros'],['thousands_sep']]);
		...
		$method = $pyjs__bind_method2('_group_digits', function(spec, digits) {
			...
			var $cmp108,$attr305,$eq211,$cmp107,$cmp104,$eq212,$cmp103,done,n_ts,min_width,previous,group,$attr310,ts,grouping_state,$cmp106,$bool413,$bool412,$bool411,$bool410,$cmp105,$bool414,$attr304,count,$attr306,$attr307,$attr300,$attr301,$attr302,$attr303,$attr308,$attr309,n_chars,n_zeros,$122,$121,buf,groupings,$and54,$attr299,$and53,$bool416,$bool408,$bool409,$bool415,need_separator,final_grouping,grouping,left;
			buf = $p['list']([]);
			...
			while ((($bool408=true) === null || $bool408 === false || $bool408 === 0 || $bool408 === '' ?
				...
				n_zeros = $m['max'](0, (final_grouping)-(left));
	...
	, 1, [null,null,['self'],['spec'],['digits']]);
		...
		$method = $pyjs__bind_method2('_upcase_string', function(s) {
			...
			var $cmp111,$iter33_iter,$iter33_nextval,$iter33_type,index,$bool417,$cmp109,c,$cmp112,$iter33_idx,$cmp110,buf,$iter33_array;
			buf = $p['list']([]);
			$iter33_iter = s;
	...
	, 1, [null,null,['self'],['s']]);
		...
		$method = $pyjs__bind_method2('_fill_number', function(spec, num, to_digits, to_prefix, fill_char, to_remainder, upper, grouped_digits) {
			...
			var $attr317,$attr315,$attr314,$attr313,$attr312,$attr311,$attr316,$eq213,$eq214,$attr319,$attr318,out,$attr327,pref,$attr328,$bool419,$bool418,$attr322,$attr323,$attr320,$attr326,$attr324,$attr325,$attr336,$cmp113,$cmp114,$attr340,$attr341,$attr342,$attr338,stop,$bool429,$attr335,$bool427,$123,$attr333,sign,$127,$126,$125,$124,digits,$attr337,$attr321,$attr329,$attr331,$attr330,$128,$attr339,$bool428,$attr332,$bool426,$attr334,$bool424,$bool425,$bool422,$bool423,$bool420,$bool421;
			out = self['_builder']();
					...
					(typeof $bool420=='object'?
						(typeof $bool420['__nonzero__']=='function'?
							...
							(typeof $bool420['__len__']=='function'?
								...
								true ) ) :
						 true ) )) {
				pref = $p['__getslice'](num, to_prefix, (to_prefix)+(spec['n_prefix']));
	...
	, 1, [null,null,['self'],['spec'],['num'],['to_digits'],['to_prefix'],['fill_char'],['to_remainder'],['upper'],['grouped_digits', null]]);
		...
		$method = $pyjs__bind_method2('_format_int_or_long', function(w_num, kind) {
			...
			var $eq219,$eq218,n_remainder,$bool439,upper,$attr353,$attr352,$attr351,$attr350,$eq215,$attr356,$eq217,$eq216,n_digits,result,$130,$bool438,fill,$eq224,sign_char,spec,$eq225,$eq226,tp,$bool431,$bool430,$bool433,$bool432,$eq220,$eq221,$eq222,$eq223,msg,$bool435,$or40,to_prefix,$eq228,$eq229,$bool434,$attr348,$attr349,$eq238,$bool437,$eq240,$attr355,$attr343,$attr344,$attr345,$attr346,$attr347,$or42,$129,base,$bool442,$or43,$attr354,$bool436,$or41,$eq237,$eq227,$eq234,value,to_remainder,$eq233,$eq232,$eq231,$eq230,$bool440,$eq236,$eq235,n_prefix,$eq239,$bool441,skip_leading,to_numeric;
			if ((($bool430=!(($eq215=self['_precision'])===($eq216=-(1))&&$eq215===null?true:
			...
			if ((($bool431=(($eq217=tp)===($eq218='c')&&$eq217===null?true:
				...
				n_digits = ($m['len'](result))-(skip_leading);
				n_remainder = 0;
				to_remainder = 0;
	...
	, 1, [null,null,['self'],['w_num'],['kind']]);
		...
		$method = $pyjs__bind_method2('_int_to_base', function(base, value) {
			...
			var $cmp120,$cmp121,$cmp122,$eq244,$mod5,$mod6,$cmp115,$cmp116,negative,$bool452,$bool451,$bool450,$eq246,$eq247,digit,$eq245,$eq242,$eq243,$cmp117,$eq241,$cmp119,$cmp118,$eq248,buf,mod,i,$bool444,$bool445,$bool446,$bool447,$bool443,div,$bool448,$bool449;
					...
					(typeof $bool444=='object'?
						(typeof $bool444['__nonzero__']=='function'?
							...
							(typeof $bool444['__len__']=='function'?
								...
								true ) ) :
						 true ) )) {
				div = Math['floor'](value/base);
				mod = (value)-((div)*(base));
				digit = $p['abs'](mod);
				digit += ((($bool445=((($cmp117=digit)===($cmp118=10)?0:
			...
			if ((($bool448=(($eq243=base)===($eq244=2)&&$eq243===null?true:
				...
				buf['__setitem__'](i, '#');
				buf['__setitem__']((i)-(1), $m['chr'](($m['ord']('0'))+((($mod5=base)!=null && ($mod6=10)!=null && typeof $mod5=='string'?
					$m['sprintf']($mod5,$mod6):
						...
						(typeof $bool451=='object'?
							(typeof $bool451['__nonzero__']=='function'?
								...
								(typeof $bool451['__len__']=='function'?
									...
									true ) ) :
							 true ) )) {
					buf['__setitem__']((i)-(2), $m['chr'](($m['ord']('0'))+(Math['floor'](base/10))));
					i -= 1;
				}
			}
			i -= 1;
	...
	, 1, [null,null,['self'],['base'],['value']]);
		...
		$method = $pyjs__bind_method2('format_int_or_long', function(w_num, kind) {
			...
			var $eq255,$eq254,$eq257,$attr358,$eq251,$eq250,$eq253,$eq252,$eq272,$eq276,$eq275,$eq274,$eq259,$eq258,$eq271,$eq270,$eq256,$bool467,$eq278,$or48,tp,$bool457,$bool456,$bool455,$bool454,$bool453,$or49,$eq269,$or46,$or47,$or44,$or45,$eq260,$eq261,$eq262,$eq263,$eq264,$eq265,$eq266,$eq267,$eq268,$attr357,$bool468,$eq249,w_float,$or52,$bool462,$bool463,$bool460,$bool461,$bool466,$or57,$bool464,$bool465,$eq277,$bool459,$or51,$or50,$or53,$bool458,$or55,$or54,$eq273,$or56;
	...
	, 1, [null,null,['self'],['w_num'],['kind']]);
		...
		$method = $pyjs__bind_method2('_parse_number', function(s, i) {
			...
			var $cmp124,$cmp125,$cmp126,$cmp127,$eq279,$cmp123,$cmp128,$cmp129,rest,$131,$132,$133,$134,$eq280,$bool471,$bool470,$bool472,length,$cmp130,dec_point,$bool469,$and58,$and57,$and55,$and56;
			length = $m['len'](s);
	...
	, 1, [null,null,['self'],['s'],['i']]);
		...
		$method = $pyjs__bind_method2('_format_float', function(w_float) {
			...
			var $attr370,$attr359,$eq289,n_remainder,$bool477,sign,n_digits,value,$bool473,$135,$136,fill,$eq282,$eq283,$eq281,$eq286,$eq287,$eq284,$eq285,$bool475,$bool474,$bool476,to_number,tp,default_precision,msg,have_dec_point,spec,$eq291,$attr368,$attr369,$attr366,$attr367,$attr364,$attr365,$attr362,$attr363,$attr360,$attr361,$bool480,$bool479,$bool478,digits,$eq290,$eq292,add_pct,to_remainder,flags,$eq288,result;
			flags = 0;
			default_precision = 6;
			...
			if ((($bool477=(($eq287=self['_precision'])===($eq288=-(1))&&$eq287===null?true:
			...
			n_remainder = ($m['len'](result))-(to_remainder);
			digits = result;
	...
	, 1, [null,null,['self'],['w_float']]);
		...
		$method = $pyjs__bind_method2('format_float', function(w_float) {
			...
			var $attr371,$attr372,$or60,$or61,$or62,$or63,$or64,$or65,$or66,tp,$eq303,$eq302,$eq301,$eq300,$eq307,$eq306,$eq305,$eq304,$eq309,$eq308,$bool486,$bool482,$bool490,$bool484,$bool485,$bool481,$eq293,$bool483,$eq295,$eq294,$eq297,$eq296,$eq299,$eq298,$bool487,$or59,$or58,$eq310,$bool489,$bool488;
	...
	, 1, [null,null,['self'],['w_float']]);
		...
		$method = $pyjs__bind_method2('_format_complex', function(w_complex) {
			...
			var re_grouped_digits,add_parens,im_have_dec,tp,im_n_remainder,re_remainder_ptr,skip_re,im_spec,$attr373,$attr375,$attr374,$attr377,$attr376,$attr379,$attr378,$eq330,$mod7,$mod8,out,$bool493,$bool492,$bool491,$bool497,$bool496,$bool495,$bool494,$bool499,$bool498,re_spec,tmp_align,$eq329,$eq328,$eq312,$eq321,$eq320,$eq323,$eq322,$eq325,$eq324,$eq327,$eq326,$148,$145,$144,$147,$146,$141,$140,$143,$142,re_n_remainder,$and59,tmp_fill_char,re_num,tmp_width,$eq318,$attr418,$attr410,$attr411,$attr412,$attr413,$attr414,$attr415,$attr416,$attr417,$138,$139,default_precision,$137,$attr388,$attr389,$attr384,$attr385,$attr386,$attr387,$attr380,$attr381,$attr382,$attr383,msg,re_sign,$attr408,$attr403,$attr402,$attr401,$attr400,$attr407,$attr406,$attr405,$attr404,n_im_digits,$attr399,$attr398,$attr397,$attr396,$attr395,$attr394,$attr393,$attr392,$attr391,$attr390,$eq314,$eq315,$eq316,$eq317,$eq311,$assign3,$eq313,to_real_number,$eq319,to_imag_number,$attr409,re_have_dec,$and60,fill,im_num,n_re_digits,im_remainder_ptr,im_sign,im_grouped_digits,$bool501,$bool500,$bool503,$bool502,$bool505,$bool504,$bool507,$bool506,$bool508;
			tp = self['_type'];
			self['_get_locale'](tp);
			default_precision = 6;
			...
			if ((($bool493=self['_alternate']) === null || $bool493 === false || $bool493 === 0 || $bool493 === '' ?
				...
				throw ($m['ValueError']((($mod7=msg)!=null && ($mod8=self['_alternate'])!=null && typeof $mod7=='string'?
					$m['sprintf']($mod7,$mod8):
			...
			if ((($bool498=(($eq323=self['_precision'])===($eq324=-(1))&&$eq323===null?true:
			...
			re_n_remainder = ($m['len'](re_num))-(re_remainder_ptr);
			im_n_remainder = ($m['len'](im_num))-(im_remainder_ptr);
			...
			self['_calc_padding'](self['empty'], (((re_spec['n_total'])+(im_spec['n_total']))+(1))+((add_parens)*(2)));
			out = self['_builder']();
	...
	, 1, [null,null,['self'],['w_complex']]);
		...
		$method = $pyjs__bind_method2('format_complex', function(w_complex) {
			...
			var $attr419,$eq338,$eq339,$eq332,$eq333,$eq331,$eq336,$eq337,$eq334,$eq335,$or67,$or68,$or69,tp,$bool516,$bool517,$bool514,$bool515,$bool512,$bool513,$bool510,$bool511,$attr420,$eq346,$eq345,$eq344,$eq343,$eq342,$eq341,$eq340,$or74,$or73,$or72,$or71,$or70,$bool509;
	...
	$m['formatd'] = function(x, code, precision, flags) {
		...
		var $eq350,sign,$152,$153,$150,$151,$and63,$154,alt,$mod9,$cmp132,$eq349,fmt,$bool529,$bool538,$bool530,$bool532,$bool533,$bool534,$bool535,$bool536,$bool537,$cmp134,$cmp133,$mod10,$cmp131,$eq348,$eq347,$149,$bool531,$iter34_nextval,c,$iter34_test,idx,$iter34_array,$iter34_idx,s,$and64,$iter34_iter,$iter34_type;
		...
		s = (($mod9=fmt)!=null && ($mod10=$p['tuple']([x]))!=null && typeof $mod9=='string'?
			$m['sprintf']($mod9,$mod10):
		...
		if ((($bool531=(flags)&($m['DTSF_ADD_DOT_0'])) === null || $bool531 === false || $bool531 === 0 || $bool531 === '' ?
				...
				(typeof $bool531=='object'?
					(typeof $bool531['__nonzero__']=='function'?
					 ...
					 true ) )) {
			idx = $m['len'](s);
			$iter34_iter = $m['range']($m['len'](s), 0, -(1));
			...
			while ($iter34_test = typeof ($iter34_nextval=($iter34_type?($iter34_type > 0?$iter34_iter.next(true,false):$p['wrapped_next']($iter34_iter)):$iter34_array[$iter34_idx++])) != 'undefined') {
				...
				c = (typeof ($149=s)['__array'] != 'undefined'?
					((typeof $149['__array'][$150=(idx)-(1)]) != 'undefined'?$149['__array'][$150]:
						$149['__getitem__']($150)):
						$149['__getitem__']((idx)-(1)));
				if ((($bool532='eE'['__contains__'](c)) === null || $bool532 === false || $bool532 === 0 || $bool532 === '' ?
					...
					s = ($p['__getslice'](s, 0, idx))+($m['sprintf']('%02d', $p['float_int']($p['__getslice'](s, idx, null))));
					break;
				}
				...
				if ((($bool535=((($cmp131=$m['len'](s))===($cmp132=precision)?0:
					...
					s = $m['sprintf']('%s.%se%s%02d', $p['tuple']([(typeof ($153=s)['__array'] != 'undefined'?
						((typeof $153['__array'][$154=0]) != 'undefined'?$153['__array'][$154]:
							$153['__getitem__']($154)):
							$153['__getitem__'](0)), $p['__getslice'](s, 1, null), sign, ($m['len'](s))-(1)]));
				}
			}
		}
	...
	$m['__with'] = function(mgr, func) {
		var $attr421,$attr422,exc,$bool539,$bool541,$bool540,value,$pyjs_try_err,exit;
	...
	$m['__import__'] = function(name, globals, locals, fromlist, level) {
		...
		var $bool544,module,$bool542,$and66,$and65,$bool543;
		...
		throw ($m['ImportError'](('No module named ')+(name)));
		return null;
	};
	$m['__import__']['__name__'] = '__import__';

	$m['__import__']['__bind_type__'] = 0;
	$m['__import__']['__args__'] = [null,null,['name'],['globals', $p['dict']([])],['locals', $p['dict']([])],['fromlist', $p['list']([])],['level', -(1)]];
